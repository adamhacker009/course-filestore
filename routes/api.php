...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::put('/files/{id}', [FileController::class, 'changeFileAccess']);
    Route::patch('/files/{id}', [FileController::class, 'change']);
    ...
    Route::post('/promote/{id}', [UserController::class, 'promote']);
});
